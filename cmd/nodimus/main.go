...
import (
	...
	"github.com/nodimus/nodimus/internal/logger"
	"github.com/nodimus/nodimus/internal/seccomp"
	"github.com/nodimus/nodimus/internal/server"
	"github.com/nodimus/nodimus/internal/snapshot"
...
func setupCommon(log CommonLogger, cfg ConfigProvider, dbProvider DBProvider) (*storage.DB, string, error) {
	...
	db, err := dbProvider.NewDB(filepath.Join(dataDir, "nodimus.db"))
	if err != nil {
